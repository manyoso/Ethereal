...
int search(Thread *thread, PVariation *pv, int alpha, int beta, int depth) {
    ...
    int inCheck, isQuiet, improving, staticDiff, extension, singular, skipQuiets = 0;
    ...
    staticDiff = thread->height >= 2 ? eval - thread->evalStack[thread->height-2] : 0;
    improving = staticDiff > 0;
