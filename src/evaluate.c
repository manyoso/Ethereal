...
const int PawnValue   = S(  84, 145);
const int KnightValue = S( 432, 484);
const int BishopValue = S( 447, 518);
const int RookValue   = S( 633, 818);
const int QueenValue  = S(1297,1662);
